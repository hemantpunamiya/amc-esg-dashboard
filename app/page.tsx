      ...
      <header className="bg-gradient-to-br from-[#1b2a4a] via-[#2c3e6b] to-[#1b2a4a] text-white">
        <div className="mx-auto max-w-6xl px-6 py-14 text-center">
          ...
          <p className="mb-2 text-lg text-slate-300">
            AMCs &middot; Insurance &middot; Wealth Management &middot; NBFCs
          </p>
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="rounded-2xl border-l-4 border-[#4a90d9] bg-blue-50 px-6 py-5">
            ...
            <p className="mt-1 text-sm text-slate-600">
              ...
              typically represents <strong>55&ndash;85% of total GHG footprint</strong> &mdash; far outweighing Scope 1+2 from direct operations.
      ...
      <footer className="border-t border-slate-200 bg-white py-8">
        <div className="mx-auto max-w-6xl px-6 text-center">
          ...
          <div className="mt-4 flex justify-center gap-6 text-xs text-slate-400">
            <a href="https://pharma-esg-peercomparison.vercel.app" className="hover:text-[#4a90d9]">Pharma ESG Dashboard</a>
            <span>&middot;</span>
